      ...
      <div className="max-w-4xl w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-2xl text-white/90 drop-shadow-lg">
            Your Personalized Action Plan Aligned to the Stars
          </p>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm mb-3">
                    Get personalized action plans aligned with your birth chart. Our AI analyzes your astrological profile 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {loading ? (
              <div className="glass-card p-8 text-center">
                ...
                <div className="mt-6">
                  <h3 className="text-white font-semibold text-lg mb-2">Generating Your Cosmic Timeline</h3>
                  <p className="text-white/80 text-sm mb-4">
                    We're analyzing your birth chart and creating personalized actions aligned with the stars...
                  </p>
