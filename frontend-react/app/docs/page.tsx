          ...
          <div className="glass-card p-8 space-y-8 text-white/90">
            <section>
              ...
              <ul className="list-disc list-inside mb-4 space-y-2 ml-4">
                <li>Specific actions timed to astrologically significant dates</li>
                <li>Daily affirmations to support your journey</li>
            ...
            <section>
              ...
              <p className="mb-4">
                Your timeline consists of specific actions scheduled on dates that align with favorable astrological transits. Each action includes:
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2 ml-4">
                <li><strong>Date:</strong> The optimal date to take this action based on astrological timing</li>
              ...
              <p className="mb-4">
                Each timeline includes daily affirmations to support your journey. These affirmations:
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2 ml-4">
              ...
              <ul className="list-disc list-inside mb-4 space-y-2 ml-4">
                <li>Marking actions as completed when you finish them</li>
                ...
                <li>Affirming your daily affirmation to build consistency</li>
              </ul>
            </section>
